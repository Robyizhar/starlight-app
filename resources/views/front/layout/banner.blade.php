        ...
        <ul>
            <li data-transition="fade" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"  data-thumb="{{ asset('front/assets/img/parallax/notgeneric.jpg') }}"  data-rotate="0"  data-saveperformance="off"  data-title="Parallax" data-description="">
                ...
                <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-3 dark-text"
                    ...
                    style="z-index: 5; white-space: nowrap;">Starlight Publisher
                </div>
                ...
                <div class="tp-caption tp-resizeme rev-btn  rs-parallaxlevel-0"
                    ...
                    <span class="btn btn-lg  waves-effect waves-light">Explore More</span>
                </div>
                ...
                <div class="tp-caption rev-scroll-btn  rs-parallaxlevel-0"
                    ...
                    data-responsive="off"
                    style="z-index: 9; min-width: 35px; max-width: 35px; max-width: 55px; max-width: 55px; white-space: nowrap; font-size: px; line-height: px; font-weight: 100;border-color:rgba(0, 0, 0, 0.5);border-style:solid;border-width:1px;border-radius:23px 23px 23px 23px;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
                    <span></span>
                </div>
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-8"
                    ...
                    style="z-index: 10;">
                        <div class="rs-looped rs-pendulum"  data-easing="linearEaseNone" data-startdeg="-20" data-enddeg="360" data-speed="35" data-origin="50% 50%">
                            <img src="{{ asset('front/assets/img/parallax/blurflake4.png') }}" alt="" width="240" height="240" data-ww="['240px','240px','240px','240px']" data-hh="['240px','240px','240px','240px']" data-no-retina>
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-7"
                    ...
                    style="z-index: 11;">
                        <div class="rs-looped rs-wave"  data-speed="20" data-angle="0" data-radius="50px" data-origin="50% 50%">
                            <img src="{{ asset('front/assets/img/parallax/blurflake3.png') }}" alt="" width="170" height="170" data-ww="['170px','170px','170px','170px']" data-hh="['170px','170px','170px','170px']" data-no-retina>
                        </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-4"
                    ...
                    style="z-index: 12;">
                        <div class="rs-looped rs-rotate"  data-easing="Power2.easeInOut" data-startdeg="-20" data-enddeg="360" data-speed="20" data-origin="50% 50%">
                            <img src="{{ asset('front/assets/img/parallax/blurflake2.png') }}" alt="" width="50" height="51" data-ww="['50px','50px','50px','50px']" data-hh="['51px','51px','51px','51px']" data-no-retina>
                        </div>
                </div>
                ...
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-6"
                    ...
                    style="z-index: 13;">
                        <div class="rs-looped rs-wave"  data-speed="4" data-angle="0" data-radius="10" data-origin="50% 50%">
                            <img src="{{ asset('front/assets/img/parallax/blurflake1.png') }}" alt="" width="120" height="120" data-ww="['120px','120px','120px','120px']" data-hh="['120px','120px','120px','120px']" data-no-retina>
                        </div>
                </div>
            </li>
        </ul>
