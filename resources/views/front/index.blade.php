...
<html lang="en">
    <head>
        ...
        <!--  favicon -->
        <link rel="shortcut icon" href="front/assets/img/ico/favicon.png">
        <!--  apple-touch-icon -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="front/assets/img/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="front/assets/img/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="front/assets/img/ico/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="front/assets/img/ico/apple-touch-icon-57-precomposed.png">

        <link href='https://fonts.googleapis.com/css?family=Raleway:400,300,500,700,900' rel='stylesheet' type='text/css'>
        <link href="front/assets/fonts/font-awesome/css/font-awesome.min.css" rel="stylesheet">
        <link href="front/assets/fonts/iconfont/material-icons.css" rel="stylesheet">
        <link href="front/assets/magnific-popup/magnific-popup.css" rel="stylesheet">
        <link href="front/assets/owl.carousel/assets/owl.carousel.css" rel="stylesheet">
        <link href="front/assets/owl.carousel/assets/owl.theme.default.min.css" rel="stylesheet">
        <link href="front/assets/flexSlider/flexslider.css" rel="stylesheet">
        <link href="front/assets/materialize/css/materialize.min.css" rel="stylesheet">
        <link href="front/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="front/assets/css/shortcodes/shortcodes.css" rel="stylesheet">
        <link href="front/style.css" rel="stylesheet">

        <link rel="stylesheet" type="text/css" href="front/assets/revolution/css/settings.css">
        <link rel="stylesheet" type="text/css" href="front/assets/revolution/css/layers.css">
        <link rel="stylesheet" type="text/css" href="front/assets/revolution/css/navigation.css">
    </head>
    ...
    <body id="top" class="has-header-search">
                ...
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <li>
                                <a href="javascript:void(0)">Katalog Buku</a>
                            </li>

                            <li>
                                <a href="javascript:void(0)">Cara Terbit</a>
                            </li>

                            <li>
                                <a href="javascript:void(0)">Benefit Terbit</a>
                            </li>
                            ...
                            <li>
                                <a href="javascript:void(0)">Tentang Penerbit</a>
                            </li>
         ...
         <div class="rev_slider materialize-slider">
          <ul>
            ...
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner/banner-1.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="materialize Material" data-description="">
                ...
                <!-- MAIN IMAGE -->
                <img src="front/assets/img/banner/banner-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            ...
            <li data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/banner/banner-2.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Unique Design" data-description="">
                ...
                <!-- MAIN IMAGE -->
                <img src="front/assets/img/banner/banner-2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  ...
                  <div class="portfolio portfolio-with-title col-3 gutter mt-50">
                      ...
                      <div class="portfolio-item" data-groups='["all", "branding", "photography"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <img src="front/assets/img/portfolio/portfolio-1.jpg" alt="">

                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="front/assets/img/portfolio/portfolio-1.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
                      ...
                      <div class="portfolio-item" data-groups='["all", "marketing", "websites"]'>
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              <div class="bg-overlay brand-overlay"></div>
                              <img src="front/assets/img/portfolio/portfolio-2.jpg" alt="">

                              <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="front/assets/img/portfolio/portfolio-2.jpg" class="tt-lightbox" title=""> <i class="fa fa-search"></i></a>
                                </div>
                              </div>
                          </div>
                          <div class="portfolio-title">
                      ...
                      <div class="portfolio-item" data-groups='["all", "photography", "branding"]'>
                        ...
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              <div class="bg-overlay brand-overlay"></div>
                              <img src="front/assets/img/portfolio/portfolio-3.jpg" alt="">

                              <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="front/assets/img/portfolio/portfolio-3.jpg" class="tt-lightbox" title=""> <i class="fa fa-search"></i></a>
                                </div>
                              </div>
                          </div>
                          <div class="portfolio-title">
                      ...
                      <div class="portfolio-item" data-groups='["all", "websites", "branding"]'>
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              <div class="bg-overlay brand-overlay"></div>
                              <img src="front/assets/img/portfolio/portfolio-4.jpg" alt="">

                              <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="front/assets/img/portfolio/portfolio-4.jpg" class="tt-lightbox" title=""> <i class="fa fa-search"></i></a>
                                </div>
                              </div>
                          </div>
                          <div class="portfolio-title">
                      ...
                      <div class="portfolio-item" data-groups='["all", "photography", "marketing"]'>
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              <div class="bg-overlay brand-overlay"></div>
                              <img src="front/assets/img/portfolio/portfolio-5.jpg" alt="">

                              <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="front/assets/img/portfolio/portfolio-5.jpg" class="tt-lightbox" title=""> <i class="fa fa-search"></i></a>
                                </div>
                              </div>
                          </div>
                          <div class="portfolio-title">
                      ...
                      <div class="portfolio-item" data-groups='["all", "websites",  "marketing"]'>
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              <div class="bg-overlay brand-overlay"></div>
                              <img src="front/assets/img/portfolio/portfolio-6.jpg" alt="">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6">
                      <div class="border-box">
                          <a href="#">
                            <img src="front/assets/img/client-logo/1.png" alt="clients">
                          </a>
                      </div><!-- /.border-box -->
                  </div><!-- /.col-md-3 -->
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="border-box">
                          <a href="#">
                            <img src="front/assets/img/client-logo/2.png" alt="clients">
                          </a>
                      </div><!-- /.border-box -->
                  </div><!-- /.col-md-3 -->
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="border-box">
                          <a href="#">
                            <img src="front/assets/img/client-logo/4.png" alt="clients">
                          </a>
                      </div><!-- /.border-box -->
                  </div><!-- /.col-md-3 -->
                  ...
                  <div class="col-md-3 col-sm-6">
                      <div class="border-box">
                          <a href="#">
                            <img src="front/assets/img/client-logo/5.png" alt="clients">
                          </a>
                      </div><!-- /.border-box -->
                  </div><!-- /.col-md-3 -->
                </div><!-- /.row -->
        ...
        <div id="preloader">
          <div class="preloader-position">
            <img src="front/assets/img/logo-colored.png" alt="logo" >
            <div class="progress">
        ...
        <!-- jQuery -->
        <script src="front/assets/js/jquery-2.1.3.min.js"></script>
        <script src="front/assets/bootstrap/js/bootstrap.min.js"></script>
        <script src="front/assets/materialize/js/materialize.min.js"></script>
        <script src="front/assets/js/jquery.easing.min.js"></script>
        <script src="front/assets/js/jquery.sticky.min.js"></script>
        {{-- <script src="front/assets/js/smoothscroll.min.js"></script> --}}
        <script src="front/assets/js/imagesloaded.js"></script>
        <script src="front/assets/js/jquery.stellar.min.js"></script>
        <script src="front/assets/js/jquery.inview.min.js"></script>
        <script src="front/assets/js/jquery.shuffle.min.js"></script>
        <script src="front/assets/js/menuzord.js"></script>
        <script src="front/assets/js/bootstrap-tabcollapse.min.js"></script>
        <script src="front/assets/owl.carousel/owl.carousel.min.js"></script>
        <script src="front/assets/flexSlider/jquery.flexslider-min.js"></script>
        <script src="front/assets/magnific-popup/jquery.magnific-popup.min.js"></script>
